...
--
--   type is stored as varchar(20), not a native Postgres enum -
--   Hibernate's default enum mapping expects a plain column, and
--   the application-level CalendarEventType enum enforces valid
--   values at the Java layer.
-- =============================================================
