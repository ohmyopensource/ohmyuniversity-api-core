...
public class CinecaFeesClient extends AbstractCinecaClient {
  ...
  /**
   * Retrieves the payment status indicator ("semaforo") for a student from
   * {@code /semaforo/{stuId}}.
   *
   * @param baseUrl Cineca ESSE3 base URL
   * @param jwt     Cineca JWT token
   * @param stuId   student identifier
   * @return the fee status, or {@code null} if not available
   */
  ...
  /**
   * Retrieves detailed charges for a student from {@code /addebiti-studente}.
   *
   * @param baseUrl Cineca ESSE3 base URL
   * @param jwt     Cineca JWT token
   * @param stuId   student identifier
  ...
  /**
   * Retrieves refunds for a person from {@code /lista-rimborsi/{persId}}.
   *
   * @param baseUrl Cineca ESSE3 base URL
   * @param jwt     Cineca JWT token
   * @param persId  Cineca person identifier
  ...
  /**
   * Payment status indicator ("semaforo") with a breakdown of overdue and due fee items.
   */
  ...
  /**
   * A single fee line item within the payment status breakdown.
   */
  @JsonIgnoreProperties(ignoreUnknown = true)
  ...
  /**
   * A single charge entry from the detailed student charges list.
   */
  @JsonIgnoreProperties(ignoreUnknown = true)
  ...
  public static class CinecaInvoice {
    ...
    @JsonProperty("dataPagamento")
    private String paymentDate;
    @JsonProperty("paDtVersamento")
    private String pagopaPaymentDate;
    @JsonProperty("pagatoFlg")
    private Integer paidFlg;
    @JsonProperty("fattAnnullata")
    private Integer cancelledFlg;
    @JsonProperty("iuv")
    private String iuv;
    @JsonProperty("codiceAvviso")
    private String noticeCode;
    @JsonProperty("incassatoDa")
    private String collectedFrom;
    @JsonProperty("pagopaAvviso")
    ...
    public String getPagopaPaymentDate() {
      return pagopaPaymentDate;
    }
    ...
    public Integer getPagopaAvviso() {
      return pagopaAvviso;
    }
