 ...
 *
 * <p>This DTO represents the normalized view of a student badge retrieved from Cineca
 * badge-service-v1.
 *
 * <p>It is used exclusively for API responses and does not contain any business logic or
 * persistence behavior.
 *
 * <p>The structure mirrors external Cineca data but is decoupled to ensure internal API stability
 * even if external schemas change.
 */
public class BadgeResponse {
  ...
  public void setBdgId(Long bdgId) {
    this.bdgId = bdgId;
  }
  ...
  public void setCodCds(String codCds) {
    this.codCds = codCds;
  }
  ...
  public void setDesFac(String desFac) {
    this.desFac = desFac;
  }
  ...
  public void setAaIscrAnn(Integer aaIscrAnn) {
    this.aaIscrAnn = aaIscrAnn;
  }
  ...
  public void setStaStuCod(String staStuCod) {
    this.staStuCod = staStuCod;
  }
  ...
  public Boolean getFrontImagePresent() {
  ...
  public Boolean getRearImagePresent() {
  ...
  public void setBadgeBlbId(Long badgeBlbId) {
    this.badgeBlbId = badgeBlbId;
  }
}