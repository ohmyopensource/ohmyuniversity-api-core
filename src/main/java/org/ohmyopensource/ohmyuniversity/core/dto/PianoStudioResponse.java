 ...
 *
 * This object represents the student's study plan as retrieved from
 * Cineca piani-service-v1.
 *
 * It contains the full list of academic activities (courses/exams)
 * associated with a specific degree path, including CFU, status,
 * and whether the activity is mandatory or already completed.
 */
public class PianoStudioResponse {
   ...
   *
   * Each row corresponds to a specific teaching activity within the
   * student's academic curriculum.
   */
