 ...
 *
 * This object represents the student transcript as returned by
 * Cineca libretto-service-v2, mapped into a stable internal API model.
 *
 * It is used as a read-only transport structure and does not contain
 * any business logic or persistence behavior.
 *
 * The purpose of this DTO is to decouple the internal API contract
 * from external Cineca data structures, ensuring long-term stability.
 */
public class LibrettoResponse {
  ...
  public List<RigaLibretto> getRighe() { return righe; }
  public void setRighe(List<RigaLibretto> righe) { this.righe = righe; }

  /**
   * Represents a single row in the student transcript (libretto).
   *
   * Each row corresponds to an exam or academic activity and includes:
  ...
  public static class RigaLibretto {
    ...
    public void setDataEsame(String dataEsame) { this.dataEsame = dataEsame; }
    ...
    public void setNumAppelliPrenotabili(Integer n) { this.numAppelliPrenotabili = n; }
  }
}